# Python pro Data Science (jaro 2023)

* Informace o kurzu [na webu Czechitas](https://www.czechitas.cz/kurzy/python-2).

| Týden | Blok | Téma                                                            | Odkaz                   | 
|------:|---|--------------------------------------------------------------------|-------------------------|
|    1. | Pandas a vizualizace  | Running total                                  | [odkaz](lekce-01) | 
|    2. | Pandas a vizualizace  | Pivot tabulky, vizualizace vice serii          | [odkaz](lekce-02) |
|    3. | Pandas a vizualizace  | Práce s datem a časem, funkce shift, duplicity | [odkaz](lekce-03) |
|    4. | Pandas a vizualizace  | Metody apply a rank                            | [odkaz](lekce-04) |
|    5. | Statistické metody  | Popisná statistika                               | [odkaz](lekce-05) |
|    6. | Statistické metody  | Testování statistických hypotéz                  | [odkaz](lekce-06) |
|    7. | Statistické metody  | Regrese                                          | [odkaz](lekce-07) |
|    8. | Strojové učení a umělá inteligence  | Obecná technika strojového učení | [odkaz](lekce-08) |
|    9. | Strojové učení a umělá inteligence  | Klasifikace do více tříd, grid search | [odkaz](lekce-09) |
|   10. | Strojové učení a umělá inteligence  | Rozhodovací stromy               | [odkaz](lekce-10) |
|   11. | Strojové učení a umělá inteligence  | Clustering                       | [odkaz](lekce-11) |
|   12. | Strojové učení a umělá inteligence  | NLP                              | [odkaz](lekce-12) |
